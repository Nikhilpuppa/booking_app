...
export default function PlacePage() {
    ...
    useEffect(() => {
        ...
        axios.get(`${window.location.hostname === 'localhost' 
            ? 'http://localhost:4000/places/' 
            : 'http://192.168.49.2:30001/places/'}${id}`)
            .then(response => {
                            ...
                            <div key={index} className="relative">
                                <img
                                    ...
                                    src={`${window.location.hostname === 'localhost' 
                                        ...
                                        : 'http://192.168.49.2:30001/uploads/'}${photo}`}
                                    alt={`Photo ${index + 1}`}
                                />
                            </div>
                        ))}
                    ...
                    <div className="grid gap-4">
                        {place.photos?.[1] && (
                            <img
                                ...
                                src={`${window.location.hostname === 'localhost' 
                                    ? 'http://localhost:4000/uploads/' 
                                    : 'http://192.168.49.2:30001/uploads/'}${place.photos[1]}`}
                                alt=""
                            />
                        )}
                        {place.photos?.[2] && (
                            <img
                                ...
                                src={`${window.location.hostname === 'localhost' 
                                    ? 'http://localhost:4000/uploads/' 
                                    : 'http://192.168.49.2:30001/uploads/'}${place.photos[2]}`}
                                alt=""
                            />
                        )}
                    </div>
